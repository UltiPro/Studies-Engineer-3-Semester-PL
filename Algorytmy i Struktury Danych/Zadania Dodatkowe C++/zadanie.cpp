...
int main()
{
    ...
    if (binary_search(liczby, liczby + 8, liczba1))
        cout << "Jest liczba " << liczba1;
    else
        cout << "Nie ma liczby " << liczba1;

    cout << "\n";

    if (binary_search(liczby, liczby + 8, liczba2))
        cout << "Jest liczba " << liczba2;
    else
        cout << "Nie ma liczby " << liczba2;
