...
plt.plot(y1)
plt.title(
    'Muzyka Techno w komorze bezechowej + Akustyczna odpowiedź impulsowa w łazience')
plt.ylabel('Amplituda')
plt.xlabel('Ilość Próbek')
plt.axhline(y=0, color="k",)
plt.axvline(x=0, color="k")
...
plt.plot(y2)
plt.title(
    'Muzyka Techno w komorze bezechowej + Akustyczna odpowiedź impulsowa w salonie')
plt.ylabel('Amplituda')
plt.xlabel('Ilość Próbek')
plt.axhline(y=0, color="k",)
plt.axvline(x=0, color="k")
