...
record = np.flip(record) # Odwrócenie nagrania
...
sf.write('Razdwatrzy - od tyłu.wav',record,frames_frequency) # Eksportowanie do pliku wav funkcji record o próbkowaniu 
# frames_frequency