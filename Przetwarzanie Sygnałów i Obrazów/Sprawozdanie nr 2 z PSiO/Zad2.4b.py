...
# Stworzenie randomowego szumu do połączenia z audio
noise = np.random.normal(0, 1, record.size)
...
# Eksportowanie do pliku wav funkcji noise o próbkowaniu frames_frequency
sf.write('Razdwatrzy - szum.wav', noise, frames_frequency)
...
# Eksportowanie do pliku wav funkcji noise o próbkowaniu
sf.write('Razdwatrzy - nagranie+szum.wav', record, frames_frequency)
# frames_frequency
