...
plt.legend(['sin(x)','sawtooth(x)','square(x)'],bbox_to_anchor=(1, 0.87),loc="center right") 
...
plt.title('Przebiegi periodyczne sinusoidalny, piłokształtny oraz prostokątny') # Tytuł wykresu 
