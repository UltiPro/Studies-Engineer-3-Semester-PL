...
# Określenie dziedziny <0,0.001>, Ts pomiarów w tym zakresie
x = np.arange(0, 0.001, Ts)
...
# Eksportowanie do pliku wav funkcji y o próbkowaniu Fs
sf.write('wynik.wav', y, Fs)
