...
welchf1,welchp1 = welch(noise,fs,window='hanning',nperseg=256,noverlap=128)
...
welchfsin1,welchpsin1 = welch(sinthree,fs,window='hanning',nperseg=256,noverlap=128)
welchfsin2,welchpsin2 = welch(sinthree,fs,window='hanning',nperseg=128,noverlap=64)
welchfsin3,welchpsin3 = welch(sinthree,fs,window='hanning',nperseg=64,noverlap=32)
