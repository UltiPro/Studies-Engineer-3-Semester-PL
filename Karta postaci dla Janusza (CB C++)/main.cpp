...
void Wczytaj()
{
    ...
    while(!plik.eof())
    {
        ...
        if(imie!="") lista_bohaterow.push_back(Bohater(imie,rasa,klasa,plec,poziom,hp,sila,inteligencja,zrecznosc));
    }
}
...
void Edycja_Swiata()
{
    ...
    while(in_action)
    {
        ...
        switch(wybor)
        {
            case 49: Awansuj_Bohatera(); break;
            case 50: Zmien_Imie(); break;
            case 57: in_action = false; break;
            default:
            {
                for(int i=3;i>0;i--)
                {
...
int main()
{
    ...
    while(in_action)
    {
        ...
        switch(wybor)
        {
            case 49: lista_bohaterow.push_back(Bohater::Dodaj()); break;
            case 50: Wypisz_liste_bohaterow(); system("pause"); break;
            case 51: Zapisz(); break;
            case 52:
                if(allow_to_read)
                {
                    Wczytaj();
